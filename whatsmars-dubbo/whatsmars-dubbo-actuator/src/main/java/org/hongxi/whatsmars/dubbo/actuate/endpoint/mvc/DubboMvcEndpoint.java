...
package org.hongxi.whatsmars.dubbo.actuate.endpoint.mvc;
...
public class DubboMvcEndpoint extends EndpointMvcAdapter implements ApplicationContextAware, EnvironmentAware {
     ...
     *
     * @see ReferenceAnnotationBeanPostProcessor#generateReferenceBeanCacheKey(Reference, Class)
     */
     ...
     * Original implementation:
     *
     * @see ReferenceAnnotationBeanPostProcessor#resolveInterfaceName(Reference, Class)
     */
