...
// http://jqueryvalidation.org/jQuery.validator.format/
    ...
    $.extend( $.validator, {
        ...
        methods: {
            ...
            nameText:function(value,element,param){
            ...
            phone:function(value,element,param){
                return this.optional( element ) || /^1[3|4|5|8|7][0-9]\d{8,8}$/.test( value );
            },
            rangeWithTag:function(value,element,param){
                var min = param.min;
                var max = $(param.max).val()-2000;
